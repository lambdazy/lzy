...
public class LzyStartupTests extends LzyBaseTest {
    ...
    public void testFuseWorks() throws Exception {
        ...
        Assert.assertTrue(Files.exists(Paths.get(lzyPath + File.separator + "bin")));
        Assert.assertTrue(Files.exists(Paths.get(lzyPath + File.separator + "sbin")));
        Assert.assertTrue(Files.exists(Paths.get(lzyPath + File.separator + "slots")));
    }
}
