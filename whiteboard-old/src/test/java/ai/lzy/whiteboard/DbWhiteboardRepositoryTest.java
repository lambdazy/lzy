...
public class DbWhiteboardRepositoryTest {
    ...
    private void init() throws SnapshotRepositoryException, WhiteboardRepositoryException {
        ...
        implSnapshotRepository.prepare(firstEntry, storageUri, List.of(entryIdSecond, entryIdThird), DataScheme.PLAIN);
        implSnapshotRepository.commit(firstEntry, false);
        implSnapshotRepository.prepare(fourthEntry, storageUri, List.of(entryIdFirst), DataScheme.PLAIN);
