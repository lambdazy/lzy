 ...
 * <p>
 * Default implementation in {@link DynamicByteBufferPool} is based on Apache {@code commons-pool2} and is
...
public interface ByteBufferPool {
    /**
     * Tries to borrow a {@link ByteBuffer} of size {@link #bufferSizeBytes()} from the pool,
     * waiting at most {@code timeoutMs} milliseconds for a buffer to become available.
     *
     ...
     * @throws Exception error occurred while borrowing the buffer, e.g. could not allocate the memory required
     */
    @Nonnull
