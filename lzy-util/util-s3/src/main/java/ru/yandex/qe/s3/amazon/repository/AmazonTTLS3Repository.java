...
public class AmazonTTLS3Repository<T> extends AmazonS3Repository<T> {
    public AmazonTTLS3Repository(AmazonS3 amazonS3, TTLTransmitter transmitter, int toStreamPoolSize, String bucketName, BiDirectS3Converter<T> converter) {
        super(amazonS3, transmitter, toStreamPoolSize, bucketName, converter);
    }

    public AmazonTTLS3Repository(AmazonS3 amazonS3, TTLTransmitter transmitter, int toStreamPoolSize, String bucketPrefix, int bucketsCount, BiDirectS3Converter<T> converter) {
        super(amazonS3, transmitter, toStreamPoolSize, bucketPrefix, bucketsCount, converter);
    }

    public AmazonTTLS3Repository(AmazonS3 amazonS3, TTLTransmitter transmitter, int toStreamPoolSize, String bucketPrefix, int bucketsCount, Function<String, Integer> keyHashFunction, BiDirectS3Converter<T> converter) {
        super(amazonS3, transmitter, toStreamPoolSize, bucketPrefix, bucketsCount, keyHashFunction, converter);
    }

    public AmazonTTLS3Repository(AmazonS3 amazonS3, TTLTransmitter transmitter, ExecutorService consumerExecutor, String bucketPrefix, int bucketsCount, Function<String, Integer> keyHashFunction, BiDirectS3Converter<T> converter) {
