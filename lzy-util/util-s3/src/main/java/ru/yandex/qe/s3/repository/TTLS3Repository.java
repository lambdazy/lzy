...
public abstract class TTLS3Repository<T> extends S3Repository<T> {
    public TTLS3Repository(TTLTransmitter transmitter, int toStreamPoolSize, String bucketName, BiDirectS3Converter<T> converter) {
        super(transmitter, toStreamPoolSize, bucketName, converter);
    }

    public TTLS3Repository(TTLTransmitter transmitter, int toStreamPoolSize, String bucketPrefix, int bucketsCount, BiDirectS3Converter<T> converter) {
        super(transmitter, toStreamPoolSize, bucketPrefix, bucketsCount, converter);
    }

    public TTLS3Repository(TTLTransmitter transmitter, int toStreamPoolSize, String bucketPrefix, int bucketsCount, Function<String, Integer> keyHashFunction, BiDirectS3Converter<T> converter) {
        super(transmitter, toStreamPoolSize, bucketPrefix, bucketsCount, keyHashFunction, converter);
    }

    public TTLS3Repository(TTLTransmitter transmitter, ExecutorService consumerExecutor, String bucketPrefix, int bucketsCount, Function<String, Integer> keyHashFunction, BiDirectS3Converter<T> converter) {
