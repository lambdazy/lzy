...
public class AzureTransmitterFactory extends BaseTransmitterFactory {
    ...
    public static final ParallelTransferOptions DEFAULT_PARALLEL_TRANSFER_OPTIONS = new ParallelTransferOptions().setMaxConcurrency(1);
    ...
    public Transmitter create(DownloadRetryOptions retryOptions, ParallelTransferOptions options, @Nonnull ByteBufferPool byteBufferPool, @Nonnull ListeningExecutorService transferExecutor, @Nonnull ListeningExecutorService chunksExecutor, @Nonnull ListeningExecutorService consumeExecutor) {
        return new BaseTransmitter(byteBufferPool, transferExecutor, chunksExecutor, consumeExecutor) {
            ...
            public <T> DownloadProcessingLoop<T> create(@Nonnull DownloadRequest downloadRequest, @Nonnull ThrowingFunction<MetaAndStream, T> processor, @Nullable Consumer<DownloadState> progressListener, @Nullable Executor notifyExecutor, @Nonnull ByteBufferPool byteBufferPool, @Nonnull ListeningExecutorService chunksExecutor, @Nonnull ListeningExecutorService consumeExecutor) {
                return new AzureDownloadProcessingLoop<>(client, retryOptions, byteBufferPool, chunksExecutor, consumeExecutor, downloadRequest, processor, progressListener, notifyExecutor);
            }
            ...
            public UploadProcessingLoop create(@Nonnull UploadRequest uploadRequest, @Nullable Consumer<UploadState> progressListener, @Nullable Executor notifyExecutor, @Nonnull ByteBufferPool byteBufferPool, @Nonnull ListeningExecutorService chunksExecutor) {
                return new AzureUploadProcessingLoop(client, options, byteBufferPool, chunksExecutor, uploadRequest, progressListener, notifyExecutor);
            }
        };
    }
    ...
    public Transmitter create(@Nonnull ByteBufferPool byteBufferPool, @Nonnull ListeningExecutorService transferExecutor, @Nonnull ListeningExecutorService chunksExecutor, @Nonnull ListeningExecutorService consumeExecutor) {
        return create(DEFAULT_RETRY_OPTIONS, DEFAULT_PARALLEL_TRANSFER_OPTIONS, byteBufferPool, transferExecutor, chunksExecutor, consumeExecutor);
    }

    public DownloadTransmitter fixedPoolsDownloadTransmitter(String transmitterName, int downloadsPoolSize, int chunksPoolSize, DownloadRetryOptions retryOptions, ParallelTransferOptions options) {
    ...
    public DownloadTransmitter fixedPoolsDownloadTransmitter(String transmitterName, int downloadsPoolSize, int chunksPoolSize, int streamReadFailRetryCount) {
        return fixedPoolsDownloadTransmitter(transmitterName, downloadsPoolSize, chunksPoolSize,
                new DownloadRetryOptions().setMaxRetryRequests(streamReadFailRetryCount), DEFAULT_PARALLEL_TRANSFER_OPTIONS);
    }
