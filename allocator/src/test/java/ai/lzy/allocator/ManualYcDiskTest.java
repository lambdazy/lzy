...
public class ManualYcDiskTest {
    ...
    @Test
    public void createTest() throws DiskNotFoundException {
    ...
    @Test
    public void cloneTest() throws DiskNotFoundException {
        Assert.assertThrows(
        ...
        Assert.assertThrows(DiskException.class, () -> diskManager.clone(originDisk, createDiskSpec(2)));
