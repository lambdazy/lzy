...
def unpickle(arg: str):
    arg_bytes = base64.b64decode(arg.encode("ascii"))
    return cloudpickle.loads(arg_bytes)
...
def main():
    ...
    func_s: FuncSignature = cast(
        FuncSignature,
        unpickle(argv[0]),
    )
    exec_description: Optional[ExecutionDescription] = cast(
