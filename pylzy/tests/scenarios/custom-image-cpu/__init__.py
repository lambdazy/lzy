...
@op(docker_image="lzydock/user-default:master-1.1")
def check_env_var_custom_image() -> str:
    print("op1: " + str(two()))
    return "true" # os.environ["CUSTOM_ENV"]
...
if __name__ == "__main__":
    ...
    with lzy.workflow(name="wf", interactive=False, docker_image="lzydock/user-default:master-1.1"):
