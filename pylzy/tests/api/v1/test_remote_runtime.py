...
from tests.api.v1.mocks import WorkflowServiceMock, WhiteboardIndexClientMock, OperationsServiceMock, EnvProviderMock
...
class RemoteRuntimeTests(TestCase):
    def setUp(self) -> None:
        ...
        self.lzy = Lzy(whiteboard_client=WhiteboardIndexClientMock(), py_env_provider=EnvProviderMock())
