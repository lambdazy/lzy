...
public class YcIamClient {
    public static String createServiceAccount(String uid, String iamToken, CloseableHttpClient httpclient, String folderId, String bucket) throws IOException, InterruptedException {
    ...
    public static JSONObject executeRequest(String iamToken, CloseableHttpClient httpclient, HttpPost request, String requestBody) throws IOException {
    ...
    public static AWSCredentials createStaticCredentials(String serviceAccountId, String iamToken, CloseableHttpClient httpclient) throws IOException {
