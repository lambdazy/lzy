...
public class AllocatorServiceMountsTest extends AllocatorApiTestBase {
    ...
    public void unmountShouldNotDeleteUsedVolume() throws Exception {
        ...
        mockDeleteResource(PERSISTENT_VOLUME_CLAIM_PATH, volumeClaimName,
            () -> Assert.fail("Should not delete volume claim"), 403);
    ...
    private AllocatedVm allocateWithMountPod(String sessionId)
        throws Exception
    {
