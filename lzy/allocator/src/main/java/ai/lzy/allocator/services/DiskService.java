                    ...
                    switch (request.getDiskDescriptionCase()) {
                        ...
                        case EXISTING_DISK -> {
                            ...
                            if (disk == null) {
                                ...
                                operationsDao.fail(createDiskOperation.id(), status.toByteArray(), tx);
            ...
            var diskOperation = withRetries(LOG, () -> {
                try (var tx = TransactionHandle.create(storage)) {
                    ...
                    try {
                        ...
                        operationsDao.fail(cloneDiskOperation.id(), toProto(e.getStatus()).toByteArray(), tx);
                        tx.commit();
                    ...
                    if (origDisk == null) {
                        ...
                        operationsDao.fail(cloneDiskOperation.id(), toProto(status).toByteArray(), tx);
                        tx.commit();
                        metrics.cloneDiskError.inc();
                        return null;
                    }
            ...
            var diskOperation = withRetries(LOG, () -> {
                try (var tx = TransactionHandle.create(storage)) {
                    ...
                    try {
                        ...
                        LOG.error(e.getStatus().getDescription());
                        operationsDao.fail(deleteDiskOperation.id(), toProto(e.getStatus()).toByteArray(), tx);
                        tx.commit();
                    ...
                    if (disk == null) {
                        ...
                        LOG.error(status.getDescription());
                        operationsDao.fail(deleteDiskOperation.id(), toProto(status).toByteArray(), tx);
                        tx.commit();
                        metrics.deleteDiskError.inc();
                        return null;
                    }
