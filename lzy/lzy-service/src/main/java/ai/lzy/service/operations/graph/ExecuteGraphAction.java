...
public class ExecuteGraphAction extends OperationRunnerBase {
    ...
    private ai.lzy.service.dao.DataFlowGraph dataFlowGraph;
    ...
    private void setDataFlowGraph(ai.lzy.service.dao.DataFlowGraph dfgraph) {
    ...
    private Supplier<StepResult> buildGraph() {
        return new BuildTasks(execDao, userId, wfName, execId, poolsZone, internalUserCredentials, kafkaConfig,
