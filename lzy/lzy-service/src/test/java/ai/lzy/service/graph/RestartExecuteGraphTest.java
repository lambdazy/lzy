...
import ai.lzy.service.graph.debug.OperationDaoDecorator;
...
public class RestartExecuteGraphTest extends AbstractGraphExecutionTest {
    ...
    public void executeGraphFail0() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(0).set(() -> new TerminateException("Fail before create operation"));
        executeGraphWithRestartImpl();
    }

    @Test
    public void executeGraphFail1() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(1).set(
    ...
    public void executeGraphFail2() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(2).set(() ->
    ...
    public void executeGraphFail3() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(3).set(() -> new TerminateException("Fail before building graph"));
        executeGraphWithRestartImpl();
    }
    ...
    public void executeGraphFail5() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(5).set(
    ...
    public void executeGraphFail6() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(6).set(
    ...
    public void executeGraphFail7() {
        InjectedFailures.FAIL_EXECUTE_GRAPH.get(7).set(
