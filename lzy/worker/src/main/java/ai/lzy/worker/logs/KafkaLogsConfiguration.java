...
public class KafkaLogsConfiguration extends YamlConfiguration {
    ...
    public KafkaLogsConfiguration(LoggerContext loggerContext, ConfigurationSource configurationSource,
                                  boolean enabled, String host, String pattern, String topic)
    {
