...
public enum ProtoConverter {
    ...
    public static LzyPortal.PortalSlotDesc makePortalOutputSlot(String slotUri, @Nullable LMD.DataScheme dataScheme,
                                                                String slotName, String channelId,
                                                                LMST.StorageConfig storageConfig)
    {
        return makePortalSlot(slotUri, slotName, dataScheme, channelId, LMS.Slot.Direction.OUTPUT, storageConfig);
    }

    public static LzyPortal.PortalSlotDesc makePortalInputSlot(String slotUri, @Nullable LMD.DataScheme dataScheme,
                                                               String slotName, String channelId,
                                                               LMST.StorageConfig storageConfig)
    {
        return makePortalSlot(slotUri, slotName, dataScheme, channelId, LMS.Slot.Direction.INPUT, storageConfig);
    }

    public static LzyPortal.PortalSlotDesc makePortalSlot(String slotUri, String slotName,
                                                          @Nullable LMD.DataScheme dataScheme, String channelId,
                                                          ...
                                                          LMST.StorageConfig storageConfig)
    {
        ...
        var scheme = dataScheme != null ? dataScheme : toProto(DataScheme.PLAIN);
