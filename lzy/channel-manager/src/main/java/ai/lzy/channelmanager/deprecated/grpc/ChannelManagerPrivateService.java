...
import ai.lzy.channelmanager.deprecated.channel.DirectChannelSpec;
import ai.lzy.channelmanager.deprecated.channel.SnapshotChannelSpec;
import ai.lzy.channelmanager.deprecated.db.ChannelStorage;
...
public class ChannelManagerPrivateService extends LzyChannelManagerPrivateGrpc.LzyChannelManagerPrivateImplBase {
    ...
    private boolean isValid(ai.lzy.v1.channel.deprecated.LCM.ChannelSpec channelSpec) {
        try {
