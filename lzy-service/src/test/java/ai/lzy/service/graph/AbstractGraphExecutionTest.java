...
public abstract class AbstractGraphExecutionTest extends BaseTest {
    ...
    LWFS.CreateWorkflowResponse createWorkflow() {
        var workflowName = "workflow_1";
        return authorizedWorkflowClient.createWorkflow(LWFS.CreateWorkflowRequest.newBuilder()
            ...
            stub -> {
                ...
                var operation =
                    LWF.Operation.newBuilder()
                        ...
                        .setCommand(
                            "echo 'i-am-a-hacker' > /tmp/lzy_servant_1/a && echo 'hello' > /tmp/lzy_servant_1/b")
                        .addOutputSlots(LWF.Operation.SlotDescription.newBuilder()
                            .setPath("/tmp/lzy_servant_1/a")
                            .setStorageUri(buildSlotUri("snapshot_a_1", s3locator))
                            .build())
        ...
        return new TestScenario<>(authorizedWorkflowClient,
            stub -> {
                ...
                var operation =
                    LWF.Operation.newBuilder()
                        .setName("prints strings to variables")
                        .setCommand("echo 'i-am-a-hacker' > /tmp/lzy_servant_1/a && echo 'hi' > /tmp/lzy_servant_1/b")
                        .addOutputSlots(LWF.Operation.SlotDescription.newBuilder()
                            .setPath("/tmp/lzy_servant_1/a")
                            .setStorageUri(buildSlotUri("snapshot_a_1", s3locator))
                            .build())
