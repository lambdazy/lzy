...
setuptools.setup(
    ...
    packages=['lzy', 'lzy/api', 'lzy/api/v1', 'lzy/api/v1/whiteboard', 'lzy/_proxy', 'lzy/storage',
              'lzy/servant/model', 'lzy/servant', 'lzy/pkg_info', 'lzy/cli', 'lzy/serialization', 'lzy/injections'],
    python_requires='>=3.7',
    cmdclass={
        'install': _install,
