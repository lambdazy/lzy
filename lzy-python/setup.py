...
setuptools.setup(
    ...
    packages=['lzy', 'lzy/api', 'lzy/api/whiteboard', 'lzy/api/_proxy', 'lzy/api/storage',
              'lzy/model', 'lzy/servant', 'lzy/api/pkg_info', 'lzy/cli', 'lzy/api/serialization', 'lzy/injections'],
    python_requires='>=3.7',
    cmdclass={
        'install': _install,
