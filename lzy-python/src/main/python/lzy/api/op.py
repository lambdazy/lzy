...
class LzyLocalOp(LzyOp):
    def __init__(self, func: Callable, input_types: Tuple[type, ...], return_type: type, *args):
...
class LzyRemoteOp(LzyOp):
    def __init__(self, func: Callable, input_types: Tuple[type, ...], output_type: type, *args):
    ...
    @staticmethod
    def restore(materialized: bool, materialization: Any, input_types: Tuple[Type, ...],
