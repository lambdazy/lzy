...
class GrpcRuntime(Runtime):
    ...
    def load_arg(self, entry_id: str, data: Any, serializer: Serializer):
    ...
    def load_args(self, graph: Graph, serializer: Serializer):
        for call in graph.calls():
            for name, arg in call.named_arguments():
                if not is_lazy_proxy(arg):
                    ...
                    self.load_arg(entry_id, arg, serializer)
